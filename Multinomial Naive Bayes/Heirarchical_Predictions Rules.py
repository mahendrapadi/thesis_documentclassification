...
Path_unknown='C:\Users\D065921\Documents\Mahi\Thesis\Crawling\Crawled Data\last versions\Data_POOL_ver2\SGD_LSVM(hinge)\Final Prediction_HR_SGD\Unknown'        // pathe of thre UNKNOWN 2 data set
path_predicted_categories='C:\Users\D065921\Documents\Mahi\Thesis\Crawling\Crawled Data\last versions\Data_POOL_ver2\MNB_All\MNB_Heirar\Predicted Categories'   //Path of the folder where the predicted categories have to save
...
for dirs in sub_dirs_level0:
    ...
    if dirs.endswith('.py'):
        ...
        for dirs_level1 in sub_dirs_level1:
            ...
            Load_vector = pickle.load(open((dirs_level1 + '_Vector_MNB.sav'), 'rb'))
            ...
            os.chdir(path_classifier)
            Load_model = pickle.load(open((dirs_level1 + '_Model_MNB.sav'), 'rb'))
            ...
            predicted_cnf_Unknown = Load_model.predict_proba(X_Unknown_FP)
              ...
              #print file
                ...
                if (parent_says[1]== 0) and ( sum([item[1] for item in child_says]) == 3 ):
                    ...
                    if len(child_says_yes) == 1:
                        ...
                        if child_says_yes[0][2][0] > child_says_yes[1][2][0]:
